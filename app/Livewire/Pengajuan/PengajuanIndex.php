...
class PengajuanIndex extends Component
{
    ...
    #[Validate('required',message:'Kolom Nomor Whatsapp Aktif Mahasiswa Harus Diisi')]
    #[Validate('regex:/^(08)(\d{3,4}-?){2}\d{3,4}$/',message:'Format Kolom Nomor Whatsapp Mahasiswa Salah')]
    public $no_wa_mhs = '';

    #[Validate('required',message:'Kolom Nomor Whatsapp Orang Tua/Wali Mahasiswa Harus Diisi')]
    #[Validate('regex:/^(08)(\d{3,4}-?){2}\d{3,4}$/',message:'Format Nomor Whatsapp Orang Tua/Wali Mahasiswa Salah')]
    public $no_wa_ortu = '';
