<x-layouts.errors>
    <div class="flex">
        <div class="justify-center mx-auto text-center">
            <img src="{{asset('assets/images/error400-cover.png')}}" width="500" class="mx-auto mb-5" />

            <div class="max-w-4xl mx-auto text-normal">Maaf, Halaman Yang Anda Cari Tidak Ditemukan</div>
