    ...
    <x-modal name='prodi-modal'>
        ...
        <form class="px-6 pt-6 pb-4 mb-4 bg-white rounded" wire:submit="save" wire:loading.attr="disabled">
            ...
            <div class="grid grid-cols-1 gap-4 mb-2 sm:grid-cols-2">
                <div>
                    <x-input-label for="name_prodi" :value="__('Nama Program Studi')" class="mb-2 font-semibold" />
                    <x-text-input wire:model="name_prodi" id="name_prodi"
                    class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                    type="text" name="name_prodi" placeholder="Nama Program Studi" />
                    <x-input-error :messages="$errors->get('name_prodi')" class="mt-2" />
                </div>
                <div>
                    <x-input-label for="abbr_prodi" :value="__('Singkatan Program Studi')" class="mb-2 font-semibold" />
                    <x-text-input wire:model="abbr_prodi" id="abbr_prodi"
                    class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                    type="text" name="abbr_prodi" placeholder="Singkatan Program Studi" />
                    <x-input-error :messages="$errors->get('abbr_prodi')" class="mt-2" />
                </div>
            </div>
            <div class="mb-2">
