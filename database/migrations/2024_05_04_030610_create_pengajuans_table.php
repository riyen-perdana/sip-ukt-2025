...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pengajuan', function (Blueprint $table) {
            ...
            $table->string('rknlstrk_mhs')->comment('Rekening Listrik Mahasiswa')->nullable();
            ...
            $table->string('ft_ruangtamu')->comment('Foto Rumah Ruang Tamu')->nullable();
            $table->string('ft_kamartdr')->comment('Foto Rumah Kamar Tidur')->nullable();
            $table->string('ft_ruangklrg')->comment('Foto Rumah Ruang Keluarga')->nullable();
            $table->string('ft_dapur')->comment('Foto Rumah Dapur')->nullable();
            $table->string('ft_dpnrumah')->comment('Foto Rumah Halaman Depan Rumah')->nullable();
